    ...
    <header className="navbar-fixed pt-4">
      <nav className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex items-center justify-between h-16 relative">
        ...
        <div className="hidden md:flex items-center space-x-4 relative z-10">
          {[
            { href: "https://www.linkedin.com/in/divyansh-agrawal-4556a0299", icon: FaLinkedin, label: "LinkedIn" },
            { href: "https://github.com/Divyansh8843", icon: FaGithub, label: "GitHub" },
            { href: "mailto:divyanshagrawal8843@gmail.com", icon: FaEnvelope, label: "Email" },
            { href: "https://leetcode.com/u/Divyansh8817", icon: FaCode, label: "Leetcode" },
          ].map((social) => (
            <motion.a
              key={social.label}
              href={social.href}
              ...
              <li className="pt-6 border-t border-white/10">
                <div className="flex justify-center space-x-6">
                 {[
                    ...
                    { href: "https://github.com/Divyansh8843", icon: FaGithub, label: "GitHub" },
                    { href: "mailto:divyanshagrawal8843@gmail.com", icon: FaEnvelope, label: "Email" },
                    { href: "https://leetcode.com/u/Divyansh8817", icon: FaCode, label: "Codolio" },
                  ].map((social) => (
                    <motion.a
                      key={social.label}
                      href={social.href}
